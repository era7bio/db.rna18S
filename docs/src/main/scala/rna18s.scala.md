...
## 18S RNA BLAST database

This contains the specification of our 18S BLAST database. All sequences are obtained from RNACentral, with sequences satisfying `predicate` being those included.


```scala
case object rna18s extends AnyBlastDB {

  val name      :String    = "era7bio.db.rna18s"
  val s3location: S3Folder = S3Folder("resources.ohnosequences.com", "db/rna18s/")
...
```scala
  ...
  val minimum18SLength = 1600

  val eukaryotaTaxonID          = 2759
  val unclassifiedEukaryotesID  = 42452
  val environmentalSamplesID    = 61964

  val uninformativeTaxaIDs = Set(
    unclassifiedEukaryotesID.toString,
    environmentalSamplesID.toString
  )
...
[test/scala/Dbrna18s.scala]: ../../test/scala/Dbrna18s.scala.md
[test/scala/runBundles.scala]: ../../test/scala/runBundles.scala.md
[test/scala/compats.scala]: ../../test/scala/compats.scala.md
[main/scala/rna18s.scala]: rna18s.scala.md